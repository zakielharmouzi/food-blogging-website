...
const Banner = ({ onButtonClick }) => { // Receive the onButtonClick prop
    return (
        <div className="h-full w-full m-0 flex flex-col lg:flex-row-reverse">
            <div className="relative w-full lg:w-1/2 flex">
                <img
                    alt="rectangle"
                    src="images/tajine1.png"
                    className="absolute top-0 right-0 w-[800px] h-[655px]"
                />
                <img
                    alt="vector"
                ...
                />
                <button
                    onClick={onButtonClick} // Attach the click handler
            ...
            <div className="w-full lg:w-1/2 flex flex-col p-20 lg:space-y-16">
                ...
                <div className="flex flex-col items-center space-y-8">
                    ...
                    <button className="bg-red-500 text-white text-lg p-3 px-4 w-50 rounded-full" onClick={onButtonClick}>
                        Explorez maintenant !
                    </button>
                </div>
            </div>
